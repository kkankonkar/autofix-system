...
- Advanced mode HAS access to MCP and Browser tools
- Use browser_action for testing web interfaces or verifying GitHub PR pages
- Use MCP tools when available for extended functionality