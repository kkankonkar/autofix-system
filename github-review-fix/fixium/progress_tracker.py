...
*🤖 Fixium Code Review Bot*"""
    ...
    def complete(self, total_findings: int, summary: str, bob_cost_used: str = "unknown") -> None:
        """
        ...
        Args:
            ...
            bob_cost_used: Bob usage shown as parsed Bob cost
        """
        if not self.comment_id:
            raise ValueError("Progress not started - call start() first")
