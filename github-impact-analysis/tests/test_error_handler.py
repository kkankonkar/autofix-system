...
class TestErrorHandler:
    ...
    def test_error_message_truncation(self):
        ...
        # Should be truncated to 500 characters (with buffer for markdown formatting)
        assert len(error_message) < 800  # Increased buffer for markdown code blocks and formatting
